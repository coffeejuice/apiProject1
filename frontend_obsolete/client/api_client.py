...
class NotionClient:
    ...
    def upsert_setting(self, key: str, value: Any, scope: str = "global", 
    ...
    def resolve_setting(self, key: str) -> Optional[Dict]:
        """Resolve a setting value"""
        return self._request("GET", f"/settings/resolve/{key}")

...
class Process(Base):
    ...
    heat_no: Mapped[Optional[str]] = mapped_column(String(255))
    lot_no: Mapped[Optional[str]] = mapped_column(String(255))
    finished_size: Mapped[Optional[str]] = mapped_column(String(255))
    standard_customer: Mapped[Optional[str]] = mapped_column(String(511))
    standard_wst: Mapped[Optional[str]] = mapped_column(String(511))
    product_condition: Mapped[Optional[str]] = mapped_column(String(7))
    product_surface: Mapped[Optional[str]] = mapped_column(String(63))
    product_diameter_tolerance: Mapped[Optional[str]] = mapped_column(String(63))
    product_length_tolerance: Mapped[Optional[str]] = mapped_column(String(63))
    product_curvature_tolerance: Mapped[Optional[str]] = mapped_column(String(63))
    stock_size: Mapped[Optional[str]] = mapped_column(String(63))
    stock_weight: Mapped[Optional[float]] = mapped_column(Numeric(10, 2))
    stock_no: Mapped[Optional[str]] = mapped_column(String(63))
    material_btt: Mapped[Optional[float]] = mapped_column(Numeric(6, 2))
    material_btt_sym_tolerance: Mapped[Optional[float]] = mapped_column(Numeric(6, 2))
    remarks: Mapped[Optional[str]] = mapped_column(String(4095))
    ...
    preview_status: Mapped[Optional[Status]] = mapped_column(SQLEnum(Status, name="preview_status_enum"), default=Status.empty)
